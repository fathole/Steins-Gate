...
{
    public class ODEMusicButton : ClickableObjectBase
    {
        #region Declaration
        ...
        public void SetupElement(TMP_FontAsset fontAsset, TextContentBase.HomePage.ODEMusicButton textContent, Action onPointerClickCallback)
        {
            // Setup Font Asset
