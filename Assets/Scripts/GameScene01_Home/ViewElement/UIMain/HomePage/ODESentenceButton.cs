...
{
    public class ODESentenceButton : ClickableObjectBase
    {
        #region Declaration
        ...
        public void SetupElement(TMP_FontAsset fontAsset, TextContentBase.HomePage.ODESentenceButton textContent, Action onPointerClickCallback)
        {
            // Setup Font Asset
