...
{
    public class ODEGalleryButton : ClickableObjectBase
    {
        #region Declaration
        ...
        public void SetupElement(TMP_FontAsset fontAsset, TextContentBase.HomePage.ODEGalleryButton textContent, Action onPointerClickCallback)
        {
            // Setup Font Asset
